...
```{r attrition_flag_barplot, echo=FALSE}
...
To chek for possible correlation between the variables, we computed the correlation matrix and we plotted it using a heatmap. The correlation matrix is the following:
